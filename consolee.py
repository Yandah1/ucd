...
class HBNBCommand(cmd.Cmd):
    ...
    def do_create(self, arg):
        ...
        if len(cls) == 0:
            ...
            print(eval(cls[0])(name="default_name").id)
            storage.save()
    ...
    def do_show(self, arg):
        ...
        if len(cls) == 0:
            ...
            print(o_dict["{}.{}".format(cls[0], clsl[1])])
    ...
    def do_destroy(self, arg):
        ...
        if len(cls) == 0:
            ...
            print("** instance id missing **")
        elif "{}.{}".format(cls[0], cls[1]) not in o_jdict.keys():
            print("** no instance found **")
        else:
    ...
    def do_update(self, arg):
        ...
        if len(cls) == 1:
            print("** instance id missing **")
            return False
        if "{}.{}".format(cls[0], cls[1]) not in objdict.keys():
            print("** no instance found **")
            return False
        if len(cls) == 2:
